...
class Settings(BaseSettings):
    ...
    # Voice (Kyutai) - base URL (SDK appends /stt and /tts)
    voice_kyutai_stt_url: str = "ws://localhost:16000/api/v1/ws"
    voice_kyutai_tts_url: str = "ws://localhost:16000/api/v1/ws"
