"""Chunking infrastructure for processing large inputs.

Ported from R014: services/core/chunking.py

Text chunking utilities for processing large inputs in smaller pieces.
Prevents LLM context window corruption - proven pattern (4/4 tests pass).
"""
