"""Type conversion utilities for LLM output parsing.

Ported from R014: services/tools/common/type_utils.py

These utilities handle the fact that LLMs return text, not numbers/booleans.
All DSPy agents depend on these for reliable type conversion.
"""

from typing import Union


def _to_float(value: Union[str, float, bool, None], default: float = 0.5) -> float:
