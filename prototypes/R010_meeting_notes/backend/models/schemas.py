...
class TranscriptionSegment(BaseModel):
    ...
    timestamp: float = Field(
        ...,
        description="Timestamp in seconds from the start",
        examples=[12.5],
        ge=0.0
    )
...
class MeetingNote(BaseModel):
    ...
    created_at: datetime = Field(
        ...
        description="When the meeting note was created"
    )
...
class HealthResponse(BaseModel):
    ...
    stt_available: bool = Field(
        ...,
        description="Whether speech-to-text is available",
        examples=[True]
    )
    tts_available: bool = Field(
        ...,
        description="Whether text-to-speech is available",
        examples=[True]
    )
