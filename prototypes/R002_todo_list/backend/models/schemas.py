...
class TodoUpdate(BaseModel):
    ...
    status: Status | None = Field(
        ...
        examples=[Status.IN_PROGRESS, Status.DONE]
    )
...
class TodoListResponse(BaseModel):
    ...
    todos: list[TodoResponse] = Field(
        ...
        description="List of todos (may be empty)"
    )
    total: int = Field(
        ...,
        description="Total count of all todos",
        examples=[42]
    )
